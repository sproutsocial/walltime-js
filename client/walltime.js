...
(function() {
  var Days, Milliseconds, Months, Time, helpers;
...
// Generated by CoffeeScript 1.3.3
(function() {
  var api, init, key, req_zone, val, _ref, _ref1, _ref2,
    __hasProp = {}.hasOwnProperty;
  ...
  init = function(zone) {
    ...
    WallTime = (function() {
      ...
      WallTime.prototype.setTimeZone = function(name) {
        ...
        this.zoneSet = new zone.ZoneSet(matches.zones, function(ruleName) {
  ...
  if (typeof window === 'undefined') {
    ...
    define('walltime',['olson/zone'], init);
  } else {
    this.WallTime || (this.WallTime = {});
    api = init(this.WallTime.zone);
    _ref = this.WallTime;
    for (key in _ref) {
    ...
    this.WallTime = api;
    if (this.WallTime.autoinit && ((_ref1 = this.WallTime.data) != null ? _ref1.rules : void 0) && ((_ref2 = this.WallTime.data) != null ? _ref2.zoneSet : void 0)) {
